...
# --- CSS (mantido, só adicionei flex no hero) ---
st.markdown("""
<style>
@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap');
html,body{font-family:'Inter',sans-serif}
.hero{background:linear-gradient(135deg,#1e3a8a,#3b82f6);padding:1.6rem 2rem;border-radius:16px;color:white;margin-bottom:1.5rem;display:flex;align-items:center;gap:1rem}
...
# --- HERO NOVO (única parte visual alterada) ---
try:
    with open("xml_icon.png","rb") as f:
        icon_b64 = base64.b64encode(f.read()).decode()
    icon_html = f'<img src="data:image/png;base64,{icon_b64}" width="68" height="68" style="flex-shrink:0;">'
except:
    icon_html = "📄"

st.markdown(f'<div class="hero">{icon_html}<div class="hero-text"><h1>Central XML Fiscal</h1><p>Importe sua planilha de itens SAT e converta seus dados do Excel em arquivos XML prontos para o seu sistema contábil.</p></div></div>', unsafe_allow_html=True)
...
if up:
    ...
    # Download (idêntico ao seu original)
